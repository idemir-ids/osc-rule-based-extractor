# ============================================================================================================================
# PDF_Analyzer
# File   : osc_rule_based_extractor.config.py
...
global_row_connection_threshold = 5.0 #default=5 . If there is empty space for that many times the previous row height, we will consider this as two distinct tables
